...
import { Cursor, PixelHeart, PixelStar, VisitorCounter } from "../components/PixelArt";
...
const Index = () => {
  ...
  return (
    <div className="cursor-star min-h-screen bg-gradient-to-br from-y2k-teal to-white py-8 px-4 relative">
      <Y2KBackground />
      {/* Main Container */}
      <div className="y2k-container bg-white pb-8 relative z-10">
        {/* Site Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
          ...
          <div className="md:col-span-1">
            <div className="y2k-box">
              <div className="flex flex-col items-center">
                ...
                <h1 className="y2k-title text-xl mb-2"><SparkleText>CoolUserName</SparkleText></h1>
                <div className="text-sm bg-y2k-lime text-white px-3 py-1 rounded-full mb-3">
                  <BlinkText>Online Now!</BlinkText>
                </div>
                
                <div className="w-full bg-y2k-teal/20 p-3 rounded-lg mb-3">
                  <p className="font-bold text-y2k-purple mb-1">Status:</p>
                  <p className="italic">{status}</p>
                </div>
                
                <div className="w-full bg-y2k-pink/20 p-3 rounded-lg">
            ...
            {/* Friend Space */}
            <div className="y2k-box mt-4">
              <h2 className="y2k-title text-lg mb-4">My Top Friends <Users className="inline ml-2" size={16} /></h2>
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3, 4, 5, 6].map((friend) => (
                  <div key={friend} className="text-center">
                    <div className="w-16 h-16 mx-auto bg-y2k-teal rounded-full mb-1 flex items-center justify-center text-white">
                      <User size={24} />
                    </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="y2k-box">
              <h2 className="y2k-title text-lg mb-4">My Bulletin Board <PixelStar /> <Star className="inline ml-2" size={16} /></h2>
              ...
              <div className="mb-6 pb-6 border-b-2 border-dotted border-y2k-purple">
                ...
                <h3 className="text-lg font-bold mb-2">Just hanging out</h3>
                <p>
              ...
              <div>
                ...
                <h3 className="text-lg font-bold mb-2">My new favorite song!</h3>
                <p>
            ...
            {/* Playlist Section */}
            <div className="y2k-box mt-4">
              <h2 className="y2k-title text-lg mb-4 sparkle">My Playlist <Music className="inline ml-2" size={16} /></h2>
              <div className="media-player">
                ...
                <div className="bg-black rounded-lg p-3 text-white mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
          ...
          <div className="md:col-span-1 order-2 md:order-1">
            <div className="y2k-box">
              <h2 className="y2k-title text-lg mb-3">Custom HTML Zone</h2>
              <div className="bg-y2k-teal/20 p-3 rounded-lg text-center">
                <div className="mb-2 text-y2k-purple font-bold">My Mood Today:</div>
                <BouncingText text="😊😎🥳💯✨" />
                <div className="mt-2">
            ...
            <div className="y2k-box mt-4">
              <div className="pixel-border mb-2 p-3 text-center">
                <div className="rainbow-text font-bold">
                  VISITOR COUNTER
                </div>
                <div className="bg-black text-y2k-lime font-mono font-bold mt-1 p-1">
                  12,345
                </div>
              </div>
              
              <div className="text-center">
                <div className="blink-text font-bold">
                  ★☆★ Thanks for visiting! ★☆★
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-2 order-1 md:order-2">
            <div className="y2k-box">
              <h2 className="y2k-title text-lg mb-3 flex items-center">
              ...
              <form onSubmit={handleAddComment} className="mb-4">
                ...
                <GlitterButton onClick={handleAddComment}>
                  Sign Guestbook!
                </GlitterButton>
              </form>
                ...
                {comments.map((comment, index) => (
                  <div key={index} className="mb-3 pb-3 border-b border-dotted border-y2k-purple last:border-0">
                    <div className="flex justify-between mb-1">
                      <div className="font-bold text-y2k-purple">{comment.name}</div>
        ...
        <div className="mt-8 border-t-4 border-y2k-purple pt-4 px-6">
          <div className="bg-y2k-teal/30 rounded-lg px-4 py-2 overflow-hidden">
            <MarqueeText>
              <span className="font-bold text-y2k-purple">★ Thanks for visiting my profile! ★ Add me to your friends list! ★ Comment on my posts! ★ Check back soon for updates! ★</span>
            </MarqueeText>
          </div>
